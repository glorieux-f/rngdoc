...
<ul>
  <li>Copy/paste is XML valid</li>
  <li>Generated HTML indented, even with no CSS</li>
</ul>

<h2>Revisions</h2>

<ul>
  <li>2012-12 [FG] for integration </li>
  <li>2009-04 [FG] for Rela-NG documentation</li>
  <li>2007-12 [FG] for course XML Master ID, Lille 3</li>
  <li>2004 [FG] Transfolio</li>
  <li>2002-01 [FG] Creation (SDX)</li>
</ul>
